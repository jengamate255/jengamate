...
android {
    namespace = "app.jengamate.kinglion"
    ...
    defaultConfig {
        // Production application ID (reverse of kinglion.jengamate.app)
        applicationId = "app.jengamate.kinglion"
    ...
    // Load release signing credentials from key.properties if present (not committed)
